...
RSpec.describe ForksController, type: :controller do
  ...
  # ForksController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: fork.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #new" do
    it "returns a success response" do
      get :new, params: {table_id: table_id}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      fork = Fork.create! valid_attributes
      get :edit, params: {id: fork.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "redirects to the fork" do
        fork = Fork.create! valid_attributes
        put :update, params: {id: fork.to_param, fork: valid_attributes}, session: valid_session
        expect(response).to redirect_to(fork)
      end
    end
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        fork = Fork.create! valid_attributes
        put :update, params: {id: fork.to_param, fork: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
